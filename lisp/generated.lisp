...
(let ((cell_19 (make-instance 'World :parent self :name (format nil "~a-~a-~a" name "World" "cell_19"))))
...
(let ((children (list cell_19 cell_7 cell_8 )))
(let ((connections (list  
    ...
    (make-instance 'UpConnect :sender (make-instance 'Sender :component cell_19 :port "stdout") :receiver (make-instance 'SelfReceiver :component self :port "stdout")) 
    (make-instance 'RouteConnect :sender (make-instance 'Sender :component cell_7 :port "stdout") :receiver (make-instance 'Receiver :component cell_19 :port "stdin")) 
